...
| D2 | `winner_exact_gate: "pending"` in `research/native-optimizer-funnel.json` while `research/exact-128m-gate-polar.json` records `passed: true` | open |
| D3 | `research/champion-run.json` has `"locked": false` | open |
| D4 | Champion final EMA BPB recorded as **2.010659** in `champion-run.json` vs **2.015756** in `MASTER_ARCHITECTURAL_KB.md`, `Rust_MLKit/docs/optimization_map.md` and `metal-native/DECISIONS.md` | open |
